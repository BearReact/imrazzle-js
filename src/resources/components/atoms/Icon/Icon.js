 ...
 */
const Icon = (props) => {
    const { shapeType, shapeSize, shapeColor, shapeBorder, style, isInline, className, type, onClick, size, top, bottom, left, right, color, code, isRotate, } = props;
    return (React.createElement(IconGroup, { shapeType: shapeType, shapeSize: shapeSize, shapeColor: shapeColor, shapeBorder: shapeBorder, style: style, isInline: isInline, isRotate: isRotate, className: className, onClick: onClick }, type === 'svg' ? (React.createElement(IconSvg, { className: "icon", "aria-hidden": "true", size: size, top: top, bottom: bottom, left: left, right: right, color: color },
        React.createElement("use", { xlinkHref: `#icon-${code}` }))) : (React.createElement(IconImage, { className: `iconfont icon-${code}`, size: size, top: top, bottom: bottom, left: left, right: right, color: color }))));
};
Icon.defaultProps = {
    className: '',
    type: 'fontClass',

...
export const initApiMiddleware = (getState: any, dispatch: any) => {
    /**
     * Request After Middleware
     */
    apiService.addRequestTransform((request: any) => {
     ...
     */
    apiService.addResponseTransform((response: any) => {
...
export default {
    ...
    post: async (...params: any) => reMapping(await apiService.post(...params)),
    put: async (...params: any) => reMapping(await apiService.put(...params)),
    delete: async (...params: any) => reMapping(await apiService.delete(...params)),
};
